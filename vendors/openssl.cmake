...
if(PP_USE_SYSTEM_VENDORS)
    ...
    if(PkgConfig_FOUND)
        ...
        if(OPENSSL_PKG_FOUND AND TARGET PkgConfig::OPENSSL_PKG)
            set(PP_OPENSSL_IS_SYSTEM ON)
            list(GET OPENSSL_PKG_INCLUDE_DIRS 0 PARTOUT_OPENSSL_INCLUDE_DIR)
            list(GET OPENSSL_PKG_LIBRARY_DIRS 0 PARTOUT_OPENSSL_LIBRARY_DIR)
            if(CMAKE_LIBRARY_ARCHITECTURE AND
               EXISTS "/usr/include/${CMAKE_LIBRARY_ARCHITECTURE}/openssl/opensslconf.h")
                set(PARTOUT_OPENSSL_CONFIG_INCLUDE_DIR "/usr/include/${CMAKE_LIBRARY_ARCHITECTURE}")
            endif()
...
set(PARTOUT_OPENSSL_LIBRARY_DIR "${OPENSSL_DIR}/${OPENSSL_LIBDIR}")
