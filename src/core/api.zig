...
pub const ModuleImportContext = gen.ModuleImportContext;
pub const ModuleImportContextOpenVPN = gen.ModuleImportContextOpenVPN;
pub const ModuleImportContextWireGuard = gen.ModuleImportContextWireGuard;
...
pub const OpenVPNErrorCode = gen.OpenVPNErrorCode;
...
pub const WireGuardErrorCode = gen.WireGuardErrorCode;
