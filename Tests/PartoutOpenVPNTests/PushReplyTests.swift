...
struct PushReplyTests {
    ...
    func givenMessage_whenNet30_thenIsHandled() throws {
        ...
        #expect(reply.options.ipv4?.subnets.first?.address.rawValue == "10.5.10.6")
        #expect(reply.options.ipv4?.subnets.first?.ipv4Mask == "255.255.255.252")
    ...
    func givenMessage_whenSubnet_thenIsHandled() throws {
        ...
        #expect(reply.options.ipv4?.subnets.first?.address.rawValue == "10.8.0.2")
        #expect(reply.options.ipv4?.subnets.first?.ipv4Mask == "255.255.255.0")
        #expect(reply.options.ipv4?.includesDefaultRoute == false)
    ...
    func givenMessage_whenIPv6_thenIsHandled() throws {
        ...
        #expect(reply.options.ipv4?.subnets.first?.ipv4Mask == "255.255.255.0")
        #expect(reply.options.ipv4?.includesDefaultRoute == false)
        #expect(reply.options.ipv6?.subnets.first?.address.rawValue == "fe80::601:30ff:feb7:ec01")
        #expect(reply.options.ipv6?.subnets.first?.prefixLength == 64)
