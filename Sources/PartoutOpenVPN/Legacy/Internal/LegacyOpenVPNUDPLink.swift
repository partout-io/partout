...
final class LegacyOpenVPNUDPLink: @unchecked Sendable {
...
extension LegacyOpenVPNUDPLink: LinkInterface {
    ...
    func upgraded() async throws -> LinkInterface {
        LegacyOpenVPNUDPLink(link: try await link.upgraded(), xor: xor)
    }
...
extension LegacyOpenVPNUDPLink {
