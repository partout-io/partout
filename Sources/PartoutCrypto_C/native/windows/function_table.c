...
pp_crypto_function_table pp_crypto_function_table_native_windows(void) {
    const pp_enc_function_table enc = {
        .init_seed = pp_windows_crypto_init_seed,
        .aead_create = pp_windows_crypto_aead_create,
        .aead_free = pp_windows_crypto_aead_free,
        .cbc_create = pp_windows_crypto_cbc_create,
        .cbc_free = pp_windows_crypto_cbc_free,
        .ctr_create = pp_windows_crypto_ctr_create,
        .ctr_free = pp_windows_crypto_ctr_free
    };
