...
actor WireGuardAdapter {
    ...
    init(
        ...
        backend = WireGuardBackendVendor()
    ...
    func start(tunnelConfiguration: WireGuard.Configuration) async throws {
        ...
        do {
            ...
            try await setNetworkSettings(settingsGenerator.generateNetworkSettings(
                moduleId: moduleId,
    ...
    private func makeSettingsGenerator(with tunnelConfiguration: WireGuard.Configuration) -> PacketTunnelSettingsGenerator {
        PacketTunnelSettingsGenerator(tunnelConfiguration: tunnelConfiguration)
    }
