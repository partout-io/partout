...
public final class _WireGuardConnectionV2: Connection, @unchecked Sendable {
...
private extension _WireGuardConnectionV2 {
    final class AdapterDelegate: WireGuardAdapterDelegate {
        ...
        private weak var connection: _WireGuardConnectionV2?

        init(_ ctx: PartoutLoggerContext, connection: _WireGuardConnectionV2) {
            self.ctx = ctx
